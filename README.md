...
Step #3: Edit the Python file to your needs: replace the test.txt with your text file, replace the plt.title('Graphed Data') with what your datas title is, and replace the label with what the lines label is
